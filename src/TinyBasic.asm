...
// LBL015 -- Error Handler/Reporter Routine
...
// Begin Cold Start
//
// Load start of free ram ($0400) into locations $20 and $21
...
COLD_S:  lda #$00                   // Load accumulator with $00
         ...
         lda #$04                   // Load accumulator with $02
...
LBL015:  jsr P_NWLN                 // Go print CR, LF and pad characters 
         ...
         lda $29
         jsr LBL010
LBL012:  jsr P_NWLN                 // Go print CR, LF and pad characters
LBL060:  lda $26
         sta $C6
         lda $27
         sta $C7
...
// TBIL program table
//
ILTBL:   .byte $24, BASPrompt, $91, $27, $10, $E1, $59, $C5, $2A, $56, $10, $11, $2C, $8B, $4C
...
PRMPT:   ldx #34                    // Offset of prompt in message block
...
!:			cmp #$08
			...
			lda LCDCursor         //  backup one space   
            clc
            sbc #$00
            jsr SETCursor
...
// Break routine (Cheack for run/stop key press)
BREAK:   
			clc
			lda ACIA1sta        
			and #$08               
